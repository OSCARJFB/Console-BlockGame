...
void BlockTypeTwo::rotate(const char playField[HEIGHT][WIDTH], Block& block)
{
...
inline void BlockTypeTwo::setBlock(Block& block, const Vector2 vec[6])
{
...
void BlockTypeTwo::firstState(const char playField[HEIGHT][WIDTH], Block& block)
{
...
void BlockTypeTwo::secondState(const char playField[HEIGHT][WIDTH], Block& block)
{
	int x = block.m_vector2[0].x, y = block.m_vector2[0].y;
	Vector2 vec[6] = {
		{x, y},
...
void BlockTypeTwo::thirdState(const char playField[HEIGHT][WIDTH], Block& block)
{
	int x = block.m_vector2[0].x, y = block.m_vector2[0].y;
	Vector2 vec[6] = {
		{x, y},
...
void BlockTypeTwo::fourthState(const char playField[HEIGHT][WIDTH], Block& block)
{
	int x = block.m_vector2[0].x, y = block.m_vector2[0].y;
	Vector2 vec[6] = {
		{x, y},
